  ...
  return (
    <section className="border border-[#ff7448]/35 bg-[#1d1512] p-5 shadow-[0_16px_40px_-28px_rgba(0,0,0,0.9)]">
            ...
            {AUDIO_PRESETS.map((preset) => {
              ...
              return (
                <button
                  ...
                  title={isDisabled ? "GIF format does not support audio" : undefined}
                  onClick={(e) => {
                    if (isDisabled) {
                      e.preventDefault();
                      return;
            ...
            {ENCODER_PRESETS.map((preset) => {
              ...
              return (
                <button
                  ...
                  title={!supported ? "Engine unavailable for this codec or hardware" : undefined}
                  onClick={(e) => {
                    if (!supported) {
                      e.preventDefault();
                      return;
      ...
      <button
        ...
        title={isCompressing ? "Compression in progress..." : isInspecting ? "Inspecting source..." : undefined}
        onClick={(e) => {
