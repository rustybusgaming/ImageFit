  ...
  return (
    <section className="border border-[#ff7448]/35 bg-[#1d1512] p-5 shadow-[0_16px_40px_-28px_rgba(0,0,0,0.9)]">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div>
          <p className="text-sm font-medium text-[#fff5ee]" id="label-audio">Audio</p>
        ...
        <div>
          <p className="text-sm font-medium text-[#fff5ee]" id="label-frame-rate">Frame rate</p>
          ...
          <p className="mt-3 text-sm font-medium text-[#fff5ee]" id="label-file-type">File type</p>
      ...
      {format !== "gif" ? (
        <div className="mt-4">
          <p className="text-sm font-medium text-[#fff5ee]" id="label-video-codec">Video codec</p>
      ...
      {isDesktop && format !== "gif" ? (
        <div className="mt-4">
          <p className="text-sm font-medium text-[#fff5ee]" id="label-encoding-engine">Encoding engine</p>
